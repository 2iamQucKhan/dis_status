...
[![Tiếng Việt](https://img.shields.io/badge/Ngôn_ngữ-Tiếng_Việt-red.svg)](#-tiếng-việt)
...
Nếu bạn muốn vọc vạch code hoặc tự phát triển thêm tính năng:
1. Yêu cầu hệ thống: Windows 10/11, Python 3.10+.
